...
function setStatusOffline() {
    ...
    chrome.browserAction.setIcon({path: chrome.extension.getURL("icons/128x128/icon_gray.png")});
    cfg.status = "offline";
}

function setStatusAuthorized() {
    console.log("Setting status as authorized");
    chrome.browserAction.setIcon({path: chrome.extension.getURL("icons/128x128/icon.png")});
    cfg.status = "authorized";
}

function setStatusUnauthorized() {
    console.log("Setting status as unauthorized!");
    chrome.browserAction.setIcon({path: chrome.extension.getURL("icons/128x128/icon_error.png")});
